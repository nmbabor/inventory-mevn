      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header card-info">
            <i class="fa fa-edit"></i> Edit Vendor Info
          ...
          <div class="card-body">
            <form method="POST" @submit.prevent="update">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-8">
                  <input type="text" v-model="form.bank_account" class="form-control" placeholder="Bank account" value="" id="bank_account">
                </div>
              </div>
              <div class="form-group row">
...
export default {
  ...
  methods: {
    async getData () {
      ...
      const response = await VendorService.show(this.$route.params.id)
      this.form = response.data
      this.form.id = this.$route.params.id
      this.photoUrl = this.$baseUrl+this.form.photo
      this.logoUrl = this.$baseUrl+this.form.logo
    },
    ...
    async update () {
      ...
      await VendorService.update(formData,this.$route.params.id)
        .then(res => {
          this.$swal({
            type: 'success',
