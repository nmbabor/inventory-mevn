            ...
            <form method="POST" @submit.prevent="validateBeforeSubmit" id="saveEmployee" accept-charset="UTF-8" class="form-horizontal author_form" enctype="multipart/form-data">
              ...
              <div class="personal-data">
                ...
                <div class="row"> <!-- start row-->
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="doj_in_bncc"  v-model="employee.doj_in_bncc" v-validate="'required'" placeholder="Date of Joining in BNCC"></datetime>
                ...
                <div class="row"> <!-- start row-->
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="doj_in_po"  v-model="employee.doj_in_po"  v-validate="'required'" placeholder="Date of Joining in Present Office"></datetime>
                ...
                <div class="row"> <!-- start row-->
                  ...
                  <div class="col-md-8">
                    <div class="form-group form-group-sm">
                      <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="do_promotion"  v-model="employee.do_promotion" v-validate="'required'" placeholder="Date of Promotion"></datetime>
                ...
                <div class="row"> <!-- start row-->
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="row"><!-- start sub row-->
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="date_of_issue"  v-model="employee.passport_details[0].date_of_issue" placeholder="Date of Issue"></datetime>
                    ...
                    <div class="row"><!-- start sub row-->
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="date_of_expire"  v-model="employee.passport_details[0].date_of_expire" placeholder="Date of Expire"></datetime>
                      ...
                      <table class="table table-bordered table-striped table-hover">
                          ...
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="visited_date_from"  v-model="employee.visited_countries[0].visited_date_from" placeholder="From date" ></datetime>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="visited_date_to"  v-model="employee.visited_countries[0].visited_date_to" placeholder="To date"></datetime>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr class="country-visit">
                          ...
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="visited_date_from"  v-model="employee.visited_countries[1].visited_date_from" placeholder="From date"></datetime>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="visited_date_to"  v-model="employee.visited_countries[1].visited_date_to" placeholder="To date"></datetime>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr class="country-visit">
                          ...
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="visited_date_from"  v-model="employee.visited_countries[2].visited_date_from" placeholder="From date"></datetime>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="visited_date_to"  v-model="employee.visited_countries[2].visited_date_to" placeholder="To date"></datetime>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr class="country-visit">
                          ...
                          <td>
                            <div class="row duration">
                              <div class="col-md-6 col-sm-6">
                                <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="visited_date_from"  v-model="employee.visited_countries[3].visited_date_from" placeholder="From date"></datetime>
                              </div>
                              <div class="col-md-6 col-sm-6">
                                <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="visited_date_to"  v-model="employee.visited_countries[3].visited_date_to" placeholder="To date"></datetime>
                              </div>
                            </div>
                          </td>
                    ...
                    <div class="country table-responsive">
                      <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr class="country-visit">
                          ...
                          <td>
                            <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="children1_dob" v-model="employee.childrenes[0].children1_dob" placeholder="First Children Date of Birth"></datetime>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>2</td>
                          ...
                          <td>
                            <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="children2_dob" v-model="employee.childrenes[1].children2_dob" placeholder="Second Children Date of Birth"></datetime>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>3</td>
                          ...
                          <td>
                            <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="children3_dob" v-model="employee.childrenes[2].children3_dob" placeholder="Third Children Date of Birth"></datetime>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>4</td>
                          ...
                          <td>
                            <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="children4_dob"  v-model="employee.childrenes[3].children4_dob" placeholder="Forth Children Date of Birth"></datetime>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>5</td>
                          ...
                          <td>
                            <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="children5_dob"  v-model="employee.childrenes[4].children5_dob" placeholder="Fifth Children Date of Birth"></datetime>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>6</td>
                          ...
                          <td>
                            <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="children6_dob"  v-model="employee.childrenes[5].children6_dob" placeholder="Sic Children Date of Birth"></datetime>
                          </td>
                        </tr>
                        <tr class="country-visit">
                          <td>7</td>
                          ...
                          <td>
                            <datetime type="date" format="dd-MM-yyyy" input-class="form-control" name="children7_dob"  v-model="employee.childrenes[6].children7_dob" placeholder="Seven Children Date of Birth"></datetime>
                          </td>
                        </tr>
                        </tbody>
                      </table>
